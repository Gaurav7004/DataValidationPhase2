...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, TabWidget):
        ...
        self.pushButton_14.setText(_translate("TabWidget", "Export Validated Data"))
        ...
        self.pushButton_2.setText(_translate("TabWidget", "Export Validated Result"))
        ...
        self.pushButton_41.setText(_translate("TabWidget", "निर्यात मान्य डेटा"))
        ...
        self.pushButton_3.setText(_translate("TabWidget", "निर्यात मान्य रिजलट"))
    ...
    def filterdataFacilityName(self, final_list):
        global df
        df = df[df['col_14'].isin(final_list)]
        return df
    ...
    def summaryReport(self, df):
        global final_result_summ1, final_result_summ2, col_sum, dft_ARFacilityWise, dft_ARCheckWiseInc, FList1, dft_ARCheckWisePRE, FList2, dft_FacilityWisePRE, dataframeForSheet6, dataframeForSheet7, FList3, FList4, FList4_duplicate, dataframeForSheet4, dataframeForSheet5
        FType = self.lineEdit_2.text()
        ...
        colInterest = df['col_14'].to_numpy() # Give column names in addition
    ...
    def reopenAndDesignExcel(self, filename, table_result_content, table_result1, table_result2, table_result3, table_result4, table_result5, table_result6, df):
        ...
        for i in range(len(FList3)):
            # print(sheet.cell(row=i+3, column=8).value)
        ...
        for i in range(len(FList2)):
            if sheet_1.cell(row=i+3, column=5).value == None:
                sheet_1.delete_rows(i+3, 1)
            elif sheet_1.cell(row=i+3, column=5).value == None:
                sheet_1.delete_rows(i+3, 1)
            elif sheet_1.cell(row=i+3, column=5).value == 0:
                k = k + 1 
        ...
        sheet_0['C8'] = "This sheet provides the list of the checks giving Inconsistencies within the dataset with the count and the\n description."
        ...
        #Second
        sheet_0['B37'] = "Recurring data items [service for one data items may be provided over months]:  Considering permissible limit of +-50% i.e., if the disparity in the \ntwo data items is more than the limit then it is a probable reporting error."
