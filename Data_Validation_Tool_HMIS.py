...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout.addWidget(self.pushButton_4, 2, 9, 1, 1)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.gridLayout_4.addWidget(self.pushButton_45, 2, 9, 1, 1)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, TabWidget):
        ...
        TabWidget.setWindowTitle(_translate("TabWidget", "Data Validation Tool by HMIS"))
    ...
    def summaryReport(self, df):
        ...
        # dataframeForSheet6 = dataframeForSheet6.update(dataframeForSheet6[['Facility Name', 'Block', 'Sub-district', 'District', 'State']].fillna('Not Available in Dataset'))
...
# EXPORT FILE
    ...
    def reopenAndDesignExcel(self, filename, table_result_content, table_result1, table_result2, table_result3, table_result4, table_result5, table_result6, df):
        ...
        sheet_0['B8'] = "Validation rule wise summary"
        sheet_0['B9'] = "Inconsistency-wise facilities"
        sheet_0['B10'] = "PRE-wise facilities"
        sheet_0['B11'] = "Facility-wise inconsistencies"
        sheet_0['B12'] = "Facility-wise PRE"
