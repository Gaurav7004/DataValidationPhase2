...
from PyQt5.QtWidgets import QFileDialog, QLabel,QMessageBox, QSizePolicy, QWidget
...
"")
        ...
        self.lineEdit_4.setGeometry(QtCore.QRect(310, 10, 701, 61))
        font = QtGui.QFont()
...
"")
        ...
        self.label_21.setGeometry(QtCore.QRect(10, 80, 621, 21))
        font = QtGui.QFont()
...
"")
        ...
        self.pushButton_19.setGeometry(QtCore.QRect(1350, 10, 211, 61))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.pushButton_20.setGeometry(QtCore.QRect(1350, 120, 211, 61))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.lineEdit_7.setGeometry(QtCore.QRect(310, 10, 691, 61))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.label_33.setGeometry(QtCore.QRect(10, 80, 621, 21))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(8)
        font.setBold(False)
        ...
        self.pushButton_36.setGeometry(QtCore.QRect(1330, 10, 231, 61))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.pushButton_37.setGeometry(QtCore.QRect(1330, 120, 231, 61))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
...
"")
    ...
    def retranslateUi(self, TabWidget):
        ...
        self.label_21.setText(_translate("TabWidget", "* Upload data in .xls / .xlsx format for one facility type only."))
        ...
        self.label_33.setText(_translate("TabWidget", "* केवल एक स्वास्थ्य केंद्र के लिए .xls / .xlsx प्रारूप में डेटा अपलोड करें।"))
    ...
    def summaryReport(self, df):
        ...
        def select_col(X):
            global c, cnt1, cnt2, cnt3, cnt4, cnt5, cnt6, cnt7, cnt8, cnt9, cnt10
            # COLORS
    ...
    def export(self):
        ...
        for i in range(len(df.axes[0])):
            for j in range(len(df.axes[1])):
                if sheet_6.cell(row=i+2, column=j+2) is 'Inconsistent':
