...
"")
        ...
        self.pushButton_2.setStyleSheet("background-color: #003679;color: white;\n"
"")
...
"")
    ...
    def export(self):
       ...
       # PALETTES
        ...
        sheet_0['C16'] = ""
        sheet_0['C17'] = "The respective validation check holds true and needs no scrutiny."
        sheet_0['C18'] = "The respective validation check fails and the inconsistent data item is flagged. "
        sheet_0['C19'] = "The respective validation check may fail and it is subject to confirmation with the concerned authority. Check and verify."
